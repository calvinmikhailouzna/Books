        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="<?php echo site_url('dashboard/books'); ?>">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
              Data Buku
            </a>
          </li>
          <li class="nav-item">
            <!-- arahkan link ke kontroller 'dashboard/kategori' -->
            <a class="nav-link" href="<?php echo site_url('category'); ?>" <?php show() ?>>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bookmark"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></path></svg>
              Kategori
            </a>
          <li class="nav-item">
            <!-- arahkan link ke kontroller 'dashboard/add' -->
            <a class="nav-link" href="<?php echo site_url('user'); ?>" <?php show() ?>>
